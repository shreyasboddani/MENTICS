...
4.  **Set up your environment variables:**
    ...
    PUBLIC_APP_URL='https://mentics.vercel.app'  # Vercel previews only
...
3. In **Vercel -> Project Settings -> Environment Variables**, add:
   ...
   - `PUBLIC_APP_URL=https://mentics.vercel.app` so preview Google-login links
     safely start the OAuth flow on the stable production domain
