import { a as api$1, i as Starfield, n as ArenaCalculatorToggle, o as boot, r as AppShell, t as ArenaCalculator } from "../entry-server.js";
import { memo, useCallback, useEffect, useMemo, useRef, useState } from "react";
import { createPortal } from "react-dom";
import { toast } from "sonner";
import { ArrowRight, Brain, Check, ChevronRight, Clock3, Dices, Flame, RotateCcw, RotateCw, Sparkles, Swords, Target, Trophy, Volume2, VolumeX, X, Zap } from "lucide-react";
...
function ArenaAvatarPreview({ avatar, label = "Your fighter", paused = false, view = "full" }) {
	...
	useEffect(() => {
		...
		const observer = new IntersectionObserver((entries) => {
			...
			observer.disconnect();
			import("./arena-avatar-scene-DJdDsD1r.js").then(({ createAvatarScene }) => {
				if (cancelled) return;
